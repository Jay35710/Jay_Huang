...
class SMTPConnection extends EventEmitter {
     ...
     * '334 <challenge7 string>'. Data to be sent as response needs to be
     * base64 decoded challenge7 string, MD5 hashed using the password as
    ...
    _actionAUTH_CRAM_MD5(str, callback) {
        ...
        if (!challengeMatch) {
            return callback(this._formatError('Invalid login sequence while waiting for server challenge7 string', 'EAUTH', str, 'AUTH CRAM-MD5'));
        } else {
